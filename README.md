...
> - 실제 초등/중등학교에서의 강의내용과 다르지 않지만, 책보단 사회적 변화 위주로 내용으로 이론이 별로 없음
> - 컴퓨터와 데이터라는 개념을 처음으로 사용하게 될 것이기 때문에, 익숙하지 않아 상대적으로 자세하지도 친절하지도 않게 느낄 수 있음
> - 정상적인 컴퓨터로 수업을 진행하는데 이슈는 없지만, 컴퓨팅 환경이 이상하거나 컴퓨터 다루는데 익숙하지 않으면 예상하진 못했던 어려움 존재
> - 내가 강의하는 시간 이상으로 스스로 학습하는 시간을 들여야 할 것이며, 뒤로 갈수록 창의성을 요구하기에 점점 어렵게 느껴질 것 
